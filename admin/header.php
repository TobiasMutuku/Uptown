	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index.php" class="logo">
				<span class="logo-lg">UptownFresh</span>
			</a>
  		...
  		<aside class="main-sidebar">
    		<section class="sidebar">
      			...
      			<ul class="sidebar-menu">
                    ...
                    <li class="treeview <?php if( ($cur_page == 'paid.php') ) {echo 'active';} ?>">
			          <a href="paid.php">
					...
					<li class="treeview <?php if( ($cur_page == 'report.php') ) {echo 'active';} ?>">
                        <a href="reports.php">
                            <i class="fa fa-sticky-note"></i> <span>Product Reports</span>
                        </a>
                    </li>
